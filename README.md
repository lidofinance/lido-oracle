...
| `GW3_ACCESS_KEY`                                       | An access key to gw3.io IPFS provider                                                                                                                                    | ?        |                         |
| `GW3_SECRET_KEY`                                       | A secret key to gw3.io IPFS provider                                                                                                                                     | ?        |                         |
| `PINATA_JWT`                                           | JWT token to access pinata.cloud IPFS provider                                                                                                                           | ?        |                         |
