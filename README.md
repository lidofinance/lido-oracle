...
There are 2 logical groups of metrics
1. States right now (use it to check that the Oracle is running correctly right now)
2. Overall metrics of this Oracle system process (use it to monitor this system process)
3. Frame state on the last oracle invocation, <br>
   consists previous and current frame variables, <br>
   which are used by the Oracle to do computations.
   
| name                          | type  | group                        | description                                                      | frequency                                 | goal                                                                                                                                                                   |
|-------------------------------|-------|------------------------------|------------------------------------------------------------------|-------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| reportableFrame               | gauge | status now                   | is the current metrics build  on reportable frame or not         | every min(COUNTDOWN_SLEEP, SLEEP) seconds | give you information, what metrics do you see,  is these are used for reportable calculations or these are countdown indicators                                        |
| nowEthV1BlockNumber           | gauge | status now                   | blockchain last block                                            | every COUNTDOWN_SLEEP seconds             | blocks on Ethereum are committed approximately once every 15 seconds so this value should be constantly updated  and be aligned with these https://etherscan.io/blocks |
| daemonCountDown               | gauge | status now                   | time till the next oracle run                                    | every COUNTDOWN_SLEEP seconds             | should be decreasing to 0                                                                                                                                              |
| txSuccess                     | histogram | overall metrics                   | number of succes transactions                           | every SLEEP seconds             |                                       |
| txRevert                      | histogram | overall metrics                   | number of failed transactions                           | every SLEEP seconds             |                                       |
| resourceUTime                 | gauge | overall metrics                   | total process user time                                 | every call             |                                                |
| resourceSTime                 | gauge | overall metrics                   | total process system time                               | every call             |                                                |
| process_virtual_memory_bytes  | gauge | overall metrics                   | Virtual memory size in bytes.                               | every call             | normal RAM consumption is ~200Mb               |
| process_resident_memory_bytes | gauge | overall metrics              | Resident memory size in bytes.                               | every call             | normal RAM consumption is ~200Mb               |
| process_start_time_seconds    | gauge | overall metrics                   | Start time of the process since unix epoch in seconds.                               | every call             | |
| process_cpu_seconds_total     | counter | overall metrics                   | Total user and system CPU time spent in seconds.                              | every call             | |
| process_open_fds              | gauge | overall metrics                   | Number of open file descriptors.             | every call             | |
| process_max_fds               | gauge | overall metrics                   | Maximum number of open file descriptors.     | every call             | |
| ----                          | ----  | ----                         | ----                                                             | ----                                      | ----                                                 |
| deltaSeconds                  | gauge | frame on previous oracle run | current.timestamp - previous.timestamp                           | every SLEEP seconds                       | should be approximately equals to the reports delay  |
| appearedValidators            | gauge | frame on previous oracle run | current.beaconValidators - previous.beaconValidators             | every SLEEP seconds                       |                                                                                                                                                                        |
| currentEthV1BlockNumber       | gauge | frame on previous oracle run | blockchain last block on the previous calculations of the oracle | every SLEEP seconds                       | blocks on Ethereum are committed approximately once every 15 seconds so this value should be constantly updated  and be aligned with these https://etherscan.io/blocks |
| currentValidatorsKeysNumber   | gauge | frame on previous oracle run | len(validators_keys)                                             | every SLEEP seconds                       |                                                                                                                                                                        |
| currentEpoch                  | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentTimestamp              | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentBeaconValidators       | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentBeaconBalance          | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentBufferedBalance        | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentDepositedValidators    | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentActiveValidatorBalance | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentTotalPooledEther       | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentTransientValidators    | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentTransientBalance       | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentValidatorsKeysNumber   | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| currentEthV1BlockNumber       | gauge | frame on previous oracle run | blockchain last block on the previous calculations of the oracle | every SLEEP seconds                       | blocks on Ethereum are committed approximately once every 15 seconds so this value should be constantly updated  and be aligned with these https://etherscan.io/blocks |
| currentValidatorsKeysNumber   | gauge | frame on previous oracle run | len(validators_keys)                                             | every SLEEP seconds                       |                                                                                                                                                                        |
| prevEpoch                     | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevTimestamp                 | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevBeaconValidators          | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevBeaconBalance             | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevBufferedBalance           | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevDepositedValidators       | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevActiveValidatorBalance    | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevTotalPooledEther          | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevTransientValidators       | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
| prevTransientBalance          | gauge | frame on previous oracle run |                                                                  | every SLEEP seconds                       |                                                                                                                                                                        |
