...
| `TELEMETRY_TX_SEND_TIMEOUT_SECONDS`                      | Total time budget to retry sending a telemetry transaction (refetching nonce and fee each attempt) before giving up. Default 120                                            | False               | `240`                                        |
