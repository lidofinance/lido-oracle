...
| `PERFORMANCE_WEB_SERVER_TIMEOUT_KEEP_ALIVE`              | Keep-alive connection timeout, seconds                                                                                                                                   | False               | `5`                                          |
...
| `PERFORMANCE_COLLECTOR_EPOCHS_BATCH_SIZE`                | Number of epochs processed in one collector batch                                                                                                                        | False               | `225`                                        |
