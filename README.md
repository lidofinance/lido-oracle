...
| `CSM_ORACLE_ADDRESS`                                   | Address of the CSFeeOracle contract                                                                                                                                      | CSM only | `0x1...`                |
...
| `CSM_ORACLE_MAX_CONCURRENCY`                           | Max count of dedicated workers for CSM module                                                                                                                            | False    | `None`                  |
