...
| `MEMBER_PRIV_KEY_2`                                      | Second candidate private key for soft key rotation (plain EOA member, or a candidate delegatee of `DELEGATION_CONTRACT_ADDRESS`). See [delegation guide](docs/delegation.md) | False               | `0x1...`                                     |
