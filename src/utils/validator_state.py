...
def has_compounding_withdrawal_credential(validator: ValidatorState) -> bool:
    ...
    https://github.com/ethereum/consensus-specs/blob/master/specs/electra/beacon-chain.md#new-has_compounding_withdrawal_credential
    """
...
def has_eth1_withdrawal_credential(validator: ValidatorState) -> bool:
    ...
    https://github.com/ethereum/consensus-specs/blob/master/specs/capella/beacon-chain.md#has_eth1_withdrawal_credential
    """
...
def has_execution_withdrawal_credential(validator: ValidatorState) -> bool:
    ...
    https://github.com/ethereum/consensus-specs/blob/master/specs/electra/beacon-chain.md#new-has_execution_withdrawal_credential
    """
...
def compute_activation_exit_epoch(ref_epoch: EpochNumber) -> EpochNumber:
    ...
    Spec: https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md#compute_activation_exit_epoch
    """
    return EpochNumber(ref_epoch + 1 + MAX_SEED_LOOKAHEAD)


# @see https://github.com/ethereum/consensus-specs/blob/master/specs/electra/beacon-chain.md#new-get_activation_exit_churn_limit
...
def get_max_effective_balance(validator: ValidatorState) -> Gwei:
    ...
    https://github.com/ethereum/consensus-specs/blob/master/specs/electra/beacon-chain.md#new-get_max_effective_balance
    """
