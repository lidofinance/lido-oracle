...
class VaultHubContract(ContractInterface):
    abi_path = './assets/Accounting.json'  # accounting contract is inherited from vault hub contract
    ...
    @lru_cache(maxsize=1)
    def get_vault_address(self, vault_id: int, blockstamp: BlockStamp) -> str:
        """
        Returns the address of the vault at the given index.
        """
