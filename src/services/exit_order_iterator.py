...
class ValidatorExitIterator:
    ...
    def _prepare_data_structure(self):
        ...
        for gid, validators_list in lido_validators.items():
            self.exitable_validators[gid] = list(filter(self.get_filter_validators_exit_epoch_set(gid), validators_list))
    ...
    def get_filter_validators_exit_epoch_set(self, gid: NodeOperatorGlobalIndex):
