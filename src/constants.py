...
EPOCHS_IN_ONE_DAY = 225

## https://eth2book.info/capella/part3/config/preset/#epochs_per_slashings_vector
SLASHINGS_PENALTY_EPOCHS_WINDOW_LEFT = 36 * EPOCHS_IN_ONE_DAY
SLASHINGS_PENALTY_EPOCHS_WINDOW_RIGHT = 18 * EPOCHS_IN_ONE_DAY
