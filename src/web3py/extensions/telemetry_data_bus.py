...
class TelemetryDataBus(Module):
    ...
    def send_telemetry(self, event_id: TelemetryEventId, data: dict | None = None, timeout: float = 0) -> bytes | None:
        ...
        tx_hash = self._send_with_retry(tx, self._data_bus_w3, variables.TELEMETRY_ACCOUNT, timeout)
