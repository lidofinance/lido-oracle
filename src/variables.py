...
PERFORMANCE_COLLECTOR_SERVER_API_PORT: Final = int(os.getenv('PERFORMANCE_COLLECTOR_SERVER_API_PORT', 9020))
PERFORMANCE_COLLECTOR_RETENTION_EPOCHS: Final = int(os.getenv('PERFORMANCE_COLLECTOR_RETENTION_EPOCHS', 28 * 225 * 6))
PERFORMANCE_COLLECTOR_SERVER_START_EPOCH: Final = int(os.getenv('PERFORMANCE_COLLECTOR_SERVER_START_EPOCH', 0))
# TODO: endless?
PERFORMANCE_COLLECTOR_SERVER_END_EPOCH: Final = int(os.getenv('PERFORMANCE_COLLECTOR_SERVER_END_EPOCH', 2 ** 64 - 1))
...
PUBLIC_ENV_VARS = {
    ...
    for key, value in {
        ...
        'PERFORMANCE_COLLECTOR_SERVER_API_PORT': PERFORMANCE_COLLECTOR_SERVER_API_PORT,
        'PERFORMANCE_COLLECTOR_RETENTION_EPOCHS': PERFORMANCE_COLLECTOR_RETENTION_EPOCHS,
        'PERFORMANCE_COLLECTOR_SERVER_START_EPOCH': PERFORMANCE_COLLECTOR_SERVER_START_EPOCH,
