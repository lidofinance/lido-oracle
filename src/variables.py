...
# TODO add to readme, why not just url?
...
def check_all_required_variables(module: OracleModuleName):
    ...
    # TODO LIDO_LOCATOR_ADDRESS should be necessary
    ...
    # TODO PERFORMANCE_COLLECTOR_URI is required
