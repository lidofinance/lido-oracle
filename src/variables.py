...
PERFORMANCE_WEB_SERVER_METRICS_PREFIX: Final = os.getenv("PERFORMANCE_WEB_SERVER_METRICS_PREFIX", "lido_performance_web")
...
PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS: Final = int(os.getenv('PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS', 28 * 225 * 6))
PERFORMANCE_COLLECTOR_DB_CONNECTION_TIMEOUT: Final = int(os.getenv('PERFORMANCE_COLLECTOR_DB_CONNECTION_TIMEOUT', 30))
PERFORMANCE_COLLECTOR_DB_STATEMENT_TIMEOUT_MS: Final = int(os.getenv('PERFORMANCE_COLLECTOR_DB_STATEMENT_TIMEOUT_MS', 10_000))
