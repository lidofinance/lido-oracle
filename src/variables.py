...
PERFORMANCE_WEB_SERVER_MAX_EPOCH_RANGE: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_MAX_EPOCH_RANGE', 225))
PERFORMANCE_WEB_SERVER_REQUEST_TIMEOUT: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_REQUEST_TIMEOUT', 60))

# - Gunicorn settings
PERFORMANCE_WEB_SERVER_WORKERS: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_WORKERS', 4))
PERFORMANCE_WEB_SERVER_WORKER_CONNECTIONS: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_WORKER_CONNECTIONS', 1000))
PERFORMANCE_WEB_SERVER_MAX_REQUESTS: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_MAX_REQUESTS', 1000))
PERFORMANCE_WEB_SERVER_TIMEOUT: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_TIMEOUT', 30))
PERFORMANCE_WEB_SERVER_KEEPALIVE: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_KEEPALIVE', 2))

PERFORMANCE_COLLECTOR_MAX_CONCURRENCY: Final = min(32, int(os.getenv('PERFORMANCE_COLLECTOR_MAX_CONCURRENCY', 2)))
PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS: Final = int(
    os.getenv('PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS', 28 * 225 * 6)
)
...
PUBLIC_ENV_VARS = {
    ...
    for key, value in {
        ...
        'PERFORMANCE_WEB_SERVER_WORKER_CONNECTIONS': PERFORMANCE_WEB_SERVER_WORKER_CONNECTIONS,
        'PERFORMANCE_WEB_SERVER_MAX_REQUESTS': PERFORMANCE_WEB_SERVER_MAX_REQUESTS,
        'PERFORMANCE_WEB_SERVER_TIMEOUT': PERFORMANCE_WEB_SERVER_TIMEOUT,
        'PERFORMANCE_WEB_SERVER_KEEPALIVE': PERFORMANCE_WEB_SERVER_KEEPALIVE,
        'PERFORMANCE_COLLECTOR_MAX_CONCURRENCY': PERFORMANCE_COLLECTOR_MAX_CONCURRENCY,
        'PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS': PERFORMANCE_COLLECTOR_DB_RETENTION_EPOCHS,
