...
PERFORMANCE_WEB_SERVER_TIMEOUT_KEEP_ALIVE: Final = int(os.getenv('PERFORMANCE_WEB_SERVER_TIMEOUT_KEEP_ALIVE', 5))
...
PERFORMANCE_COLLECTOR_EPOCHS_BATCH_SIZE: Final = int(os.getenv('PERFORMANCE_COLLECTOR_EPOCHS_BATCH_SIZE', 225))
...
PUBLIC_ENV_VARS = {
    ...
    for key, value in {
        ...
        'PERFORMANCE_WEB_SERVER_TIMEOUT_KEEP_ALIVE': PERFORMANCE_WEB_SERVER_TIMEOUT_KEEP_ALIVE,
