...
class TestStakingVaultsSmoke:
    ...
    def setup_method(self):
        ...
        self.web3.staking_vaults = StakingVaults(
            self.web3, self.cc, self.ipfs_client,
        ...
        self.hash_consensus_contract: HashConsensusContract = cast(HashConsensusContract, self.web3.eth.contract(
    ...
    def get_el_vault_balance(self, blockstamp: BlockStamp) -> ELVaultBalance:
        return ELVaultBalance(Wei(self.web3.eth.get_balance(
    ...
    def test_manual_vault_report(self):
        ...
        modules_fee, treasury_fee, base_precision = self.web3.lido_contracts.staking_router.get_staking_fee_aggregate_distribution('latest')
        lido_fee_bp = ((modules_fee + treasury_fee) / base_precision) / 0.0001 # 1_000

        rebased_event = self.web3.lido_contracts.lido.get_last_token_rebased_event(bs.block_number - 7200,
                                                                                 bs.block_number)
