...
class TestStakingVaults:
    ...
    def setup_method(self):
        ...
        # Vault addresses
        vault_adr_0 = ChecksumAddress('0xEcB7C8D2BaF7270F90066B4cd8286e2CA1154F60')
        vault_adr_1 = ChecksumAddress('0xc1F9c4a809cbc6Cb2cA60bCa09cE9A55bD5337Db')
        ...
        self.StakingVaults = StakingVaults(w3_mock, cc_mock, self.ipfs_client, vault_hub_mock)

    @pytest.mark.unit
    def test_manual_vault_report(self):
        bs = BlockStamp(state_root='0xcdbb26ef98f4f6c46262f34e980dcc92c28268ba6ca9b7d45668eb0c23cad3c3',
                      slot_number=7314880,
                        block_hash='0xbb3ba9405346f2448e9fa02b110539dde714e6e3f06bd5207dc29e14db353a3a',
                        block_number=8027890, block_timestamp=1743512160)
        ...
        validators: list[Validator] = [
            Validator(
                ...
                validator=ValidatorState(
                    ...
                    effective_balance=32000000000, slashed=False, activation_eligibility_epoch=225469,
                    activation_epoch=225475,
                    exit_epoch=18446744073709551615, withdrawable_epoch=18446744073709551615)
            ),
            Validator(index=1986, balance=0,
                      validator=ValidatorState(
                          pubkey='0xa5d9411ef615c74c9240634905d5ddd46dc40a87a09e8cc0332afddb246d291303e452a850917eefe09b3b8c70a307ce',
                          withdrawal_credentials='0x020000000000000000000000ecb7c8d2baf7270f90066b4cd8286e2ca1154f60',
                          effective_balance=0,
                          slashed=False,
                          activation_eligibility_epoch=226130,
                          activation_epoch=226136,
                          exit_epoch=227556,
                          withdrawable_epoch=227812)
                      )
        ]
