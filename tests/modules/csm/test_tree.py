...
class TestStrikeTree(TreeTestBase[StrikeTreeLeaf]):
    ...
    def values(self) -> list[StrikeTreeLeaf]:
        return [
            (NodeOperatorId(0), [Timestamp(0)]),
            (NodeOperatorId(1), [Timestamp(1), Timestamp(2), Timestamp(3)]),
            (NodeOperatorId(2), [Timestamp(42)]),
            (NodeOperatorId(UINT64_MAX), [Timestamp(1), Timestamp(2), Timestamp(3), Timestamp(4)]),
        ]
