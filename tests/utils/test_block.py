...
class TestGetBlockTimestampsBasicCases:
    ...
    def test_empty_block_set_returns_empty_dict(self, mock_w3):
        """Empty input should return empty dict without any RPC calls."""
        result = get_block_timestamps(mock_w3, set(), SECONDS_PER_SLOT)

        assert result == {}
        mock_w3.eth.get_block.assert_not_called()

    def test_single_block_fetches_once(self, mock_w3):
        """Single block should make exactly one RPC call."""
        mock_w3.eth.get_block.return_value = {"timestamp": 1000}

        result = get_block_timestamps(mock_w3, {BlockNumber(100)}, SECONDS_PER_SLOT)

        assert result == {BlockNumber(100): 1000}
        mock_w3.eth.get_block.assert_called_once_with(BlockNumber(100))

    def test_two_blocks_no_missed_slots(self, mock_w3):
        """Two consecutive blocks with no missed slots: 2 RPC calls."""
        mock_w3.eth.get_block.side_effect = [
            {"timestamp": 1000},  # first block
            {"timestamp": 1012},  # last block (1000 + 12)
        ]

        result = get_block_timestamps(mock_w3, {BlockNumber(100), BlockNumber(101)}, SECONDS_PER_SLOT)

        assert result == {BlockNumber(100): 1000, BlockNumber(101): 1012}
        assert mock_w3.eth.get_block.call_count == 2

    def test_two_blocks_with_missed_slot(self, mock_w3):
    ...
    def test_multiple_blocks_no_missed_slots_calculates_intermediate(self, mock_w3):
        """
        ...
        result = get_block_timestamps(mock_w3, blocks, SECONDS_PER_SLOT)
    ...
    def test_three_blocks_no_missed_slots(self, mock_w3):
...
class TestGetBlockTimestampsMissedSlots:
    ...
    def test_three_blocks_missed_slot_at_start(self, mock_w3):
        ...
        mock_w3.eth.get_block.side_effect = mock_get_block
    ...
    def test_three_blocks_missed_slot_at_end(self, mock_w3):
    ...
    def test_four_blocks_missed_slot_in_middle(self, mock_w3):
    ...
    def test_multiple_missed_slots_consecutive(self, mock_w3):
    ...
    def test_multiple_missed_slots_at_different_locations(self, mock_w3):
    ...
    def test_worst_case_missed_slot_between_every_block(self, mock_w3):
        ...
        assert mock_w3.eth.get_block.call_count == 5
...
class TestGetBlockTimestampsNonConsecutiveBlocks:
    ...
    def test_non_consecutive_blocks_no_missed_slots(self, mock_w3):
        """
    ...
    def test_sparse_blocks_large_gaps_no_missed_slots(self, mock_w3):
    ...
    def test_non_consecutive_with_missed_slot(self, mock_w3):
    ...
    def test_only_first_and_last_blocks_in_range(self, mock_w3):
...
class TestGetBlockTimestampsLargeRanges:
    ...
    def test_100_blocks_no_missed_slots(self, mock_w3):
    ...
    def test_1000_blocks_no_missed_slots(self, mock_w3):
    ...
    def test_large_range_single_missed_slot(self, mock_w3):
...
class TestGetBlockTimestampsRPCCallCounting:
    ...
    def test_exact_rpc_count_no_missed_slots(self, mock_w3):
        ...
        get_block_timestamps(mock_w3, blocks, SECONDS_PER_SLOT)

        assert mock_w3.eth.get_block.call_count == 2

    def test_rpc_count_with_one_missed_slot_in_four_blocks(self, mock_w3):
        ...
        assert mock_w3.eth.get_block.call_count <= 4

    def test_single_block_exactly_one_rpc_call(self, mock_w3):
        """Single block needs exactly 1 RPC call."""
        mock_w3.eth.get_block.return_value = {"timestamp": 1000}

        get_block_timestamps(mock_w3, {BlockNumber(100)}, SECONDS_PER_SLOT)
...
class TestGetBlockTimestampsCaching:
    ...
    def test_caching_prevents_duplicate_fetches(self, mock_w3):
    ...
    def test_midpoint_caching_during_binary_search(self, mock_w3):
...
class TestGetBlockTimestampsEdgeCases:
    ...
    def test_blocks_input_is_sorted_internally(self, mock_w3):
    ...
    def test_timestamps_are_integers(self, mock_w3):
    ...
    def test_large_block_numbers(self, mock_w3):
    ...
    def test_large_timestamps(self, mock_w3):
    ...
    def test_set_deduplication(self, mock_w3):
        ...
        assert result == {BlockNumber(100): 1000}
        mock_w3.eth.get_block.assert_called_once()

    def test_result_contains_all_requested_blocks(self, mock_w3):
        ...
        result = get_block_timestamps(mock_w3, requested, SECONDS_PER_SLOT)
...
class TestGetBlockTimestampsDifferentSlotTimes:
    ...
    def test_6_second_slot_time(self, mock_w3):
    ...
    def test_1_second_slot_time(self, mock_w3):
    ...
    def test_24_second_slot_time(self, mock_w3):
...
class TestGetBlockTimestampsBinarySearchBehavior:
    ...
    def test_binary_search_splits_correctly(self, mock_w3):
    ...
    def test_recursive_subdivision_with_multiple_gaps(self, mock_w3):
    ...
    def test_optimal_rpc_calls_for_single_gap(self, mock_w3):
...
class TestGetBlockTimestampsIntegrationScenarios:
    ...
    def test_typical_oracle_report_blocks(self, mock_w3):
        ...
        assert mock_w3.eth.get_block.call_count == 2  # Optimal case

    def test_sparse_event_blocks(self, mock_w3):
    ...
    def test_blocks_around_known_missed_slot_event(self, mock_w3):
...
class TestGetBlockTimestampsVsNaiveApproach:
    ...
    def test_7200_blocks_no_missed_slots_vs_naive(self, mock_w3):
        """
        ...
        optimized_calls = mock_w3.eth.get_block.call_count
        naive_calls = num_blocks

        assert optimized_calls == 2
        assert naive_calls / optimized_calls == 3600  # 3600x improvement

    def test_7200_blocks_with_single_missed_slot_vs_naive(self, mock_w3):
        """
    ...
    def test_7200_blocks_with_multiple_missed_slots_vs_naive(self, mock_w3):
        """
    ...
    def test_timestamps_correctness_for_all_7200_blocks(self, mock_w3):
        """
